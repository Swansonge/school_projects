...
04-19-2018  ers - commented out clrscr() so function would show sample run correctly
*/
...
void InsertWord(string word, Heap <WordCount, MaxWords>  &wordHeap)
{
	...
	if (wordHeap.Search(wordCount))
		...
		{
      // Trever Wagenhals 11-30-2017
      // Moved here from top of function so an existing word in a full list can be incremented.
