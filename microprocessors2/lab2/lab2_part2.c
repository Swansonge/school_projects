/*
 * 
 * *Program Title: Lab 2, Part 2 - Flashing a LED using Timer2 and an Interrupt
 * 
...
//External Interrupt 1 ISR for the pushbutton connected to RB13. Uses Timer2 as debounce delay and toggles the state of the LED on RB14. Clears the external interrupt 1 flag to check for another button press
...
//Timer2 ISR. Clears the Timer2 Interrupt flag so Timer2 can reset
 ...
 * Function: main
 * 
 * Description: Flash RB14 on and off using Timer2. Flashing will be inititated by the press of the pushbutton. Timer2 will be used as a debounce.
 * 
 * Notes:
 * 
 * RB14 -
...
int main(void) {
    ...
    PR2 = 1000;        //PR2 value loaded to be small so Timer2 can be configured as a debounce
